...
<section class="form">
  <form action="" method="post">
    ...
    <div class="form-input">
      ...
      <%--@elvariable id="temperatureUnits" type="java.util.List"--%>
      <select name="from" id="from" required>
        <c:forEach items="${temperatureUnits}" var="temperatureUnits">
          <option value="${temperatureUnits}">${temperatureUnits}</option>
        </c:forEach>
      </select>
    </div>
    <div class="form-input">
