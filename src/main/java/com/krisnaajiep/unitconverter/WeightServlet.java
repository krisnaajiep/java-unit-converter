...
Java Developer
Created on 26/04/25 09.13
@Last Modified 26/04/25 09.13
Version 1.0
*/
...
@WebServlet(name = "weightServlet", value = "/weight")
public class WeightServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        request.setAttribute("weightUnits", conversionService.getUnits("weight"));
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        if (request.getParameter("convert") != null) {
            ...
            Map<String, String> result = conversionService.convertWeight(from, to, value);
